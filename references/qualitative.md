...
| a budget drawn as a bar or glyph under the panels | a second numbers line, a scale to explain, and no precedent: none of the 90 figures draws its budget | the NFE in the method's header, "DPS (100)", and one line of numbers (DiffPIR Fig. 4; DAPS Fig. 1 prints two metrics and no budget) | SOLO teaser v04 draft, rejected by its author |
